 ...
 */
hAPI.entry = function (numEntrada, str, delimitador) {
  return "";
};
 ...
 * @see    http://www.totvs.com.br
 */
hAPI.getCardValue = function (nomeCampo) {
  return "";
};
 ...
 * @see    http://www.totvs.com.br
 */
hAPI.getAdvancedProperty = function (nomePropriedade) {
  return "";
};
 ...
 * @see    http://www.totvs.com.br
 */
hAPI.getCardData = function (numProcesso) {
  return new Object();
};
 ...
 * @see    http://www.totvs.com.br
 */
hAPI.startProcess = function (idProcesso, numAtividade, colaboradores, comentario, completaTarefa, valoresFicha, modoGestor) {
  return new Object();
};
 ...
 * @see    http://www.totvs.com.br
 */
hAPI.getUserTaskLink = function (numAtividade) {
  return "";
};
